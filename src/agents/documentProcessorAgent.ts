...
export function createDocumentProcessorAgent(modelId: string): BedrockAgent {
  return new BedrockAgent(
    'document_processor',
    `Tu es un expert en traitement de documents administratifs français.
