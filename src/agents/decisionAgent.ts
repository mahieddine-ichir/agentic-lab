...
export function createDecisionAgent(model?: BaseLlm) {
  return new LlmAgent({
    name: 'decision_maker',
    model,
    description:
      "Prononce la décision finale d'adhésion aux communautés à partir des résultats de vérification d'éligibilité.",
    instruction: `Tu es le responsable des décisions d'adhésion aux communautés.
